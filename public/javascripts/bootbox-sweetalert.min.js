...
!function (global, factory) {
    if ("function" == typeof define && define.amd) define("/advanced/bootbox-sweetalert", ["jquery", "Site"], factory); else if ("undefined" != typeof exports) factory(require("jquery"), require("Site")); else {
        var mod = {exports: {}};
        factory(global.jQuery, global.Site), global.advancedBootboxSweetalert = mod.exports
    }
    ...
    (0, _jquery2.default)(document).ready(function ($) {
        ...
        bootbox.prompt({
            title: "What is your real name?", value: "makeusabrew", callback: function (result) {
                null === result ? toastr.info("Prompt dismissed") : toastr.info("Hi <b>" + result + "</b>")
            }
        })
        ...
        bootbox.dialog({title: "That html", message: "You can also use <b>html</b>"})
    }), (0, _jquery2.default)("#editProfile").on("click", function () {
