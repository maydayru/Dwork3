    ...
    <div class="slidePanel-actions btn-group" aria-label="actions" role="group">
      <div class="dropdown float-left">
        ...
        <div class="dropdown-menu dropdown-menu-right bullet taskboard-task-datepicker">
          ...
          <div class="p-10">
            <button class="btn btn-primary due-date-save">Сохранить</button>
            <a class="btn btn-sm btn-white due-date-delete" href="javascript:void(0)">Удалить</a>
          </div>
        </div>
      </div>
      ...
      <div class="dropdown float-left">
        ...
        <div class="dropdown-menu dropdown-menu-right bullet" role="menu">
          <a class="dropdown-item taskboard-task-edit" href="javascript:void(0)" role="menuitem"><i class="icon wb-pencil" aria-hidden="true"></i>Изменить задачу</a>
          <a class="dropdown-item taskboard-task-delete" href="javascript:void(0)" role="menuitem"><i class="icon wb-trash" aria-hidden="true"></i>Удалить задачу</a>
        </div>
      </div>
    ...
    <div class="task-main">
      <div class="task-main-surface">
        <div class="priority float-right">
          <label class="mr-20">Приоритет:</label>
          <ul class="list-unstyled list-inline inline-block">
            <li class="radio-custom radio-normal list-inline-item">
              <input type="radio" class="icheckbox-grey" id="priorityNormal" data-priority="normal"
                name="priorities">
              <label for="priorityNormal">Нормальный</label>
            </li>
            <li class="radio-custom radio-high list-inline-item">
              <input type="radio" class="icheckbox-grey" id="priorityHigh" data-priority="high"
                name="priorities">
              <label for="priorityHigh">Важный</label>
            </li>
            <li class="radio-custom radio-urgent list-inline-item">
              <input type="radio" class="icheckbox-grey" id="priorityUrgent" data-priority="urgent"
                name="priorities">
              <label for="priorityUrgent">Сверхважно</label>
            </li>
          </ul>
        </div>
        ...
        <div class="description">
          ...
          <a href="#" class="description-toggle">Добавить описание.</a>
        </div>
      </div>
      <div class="task-main-editor">
        <form>
          ...
          <div class="form-group">
            <button class="btn btn-primary task-main-editor-save" type="button">Сохранить</button>
            <a class="btn btn-sm btn-white task-main-editor-cancel" href="javascript:void(0)">Отменить</a>
          </div>
        </form>
      </div>
    </div>
    <div class="task-section subtasks">
      <label><i class="icon wb-list-bulleted mr-10"></i>Подзадачи</label>
      ...
      <div class="subtasks-add">
        <form>
          ...
          <div class="form-group">
            <button class="btn btn-primary subtask-add-save" type="button">Сохранить</button>
            <a class="btn btn-sm btn-white subtask-add-cancel" href="javascript:void(0)">Отменить</a>
          </div>
        </form>
      </div>
    </div>
    <div class="task-section attachments">
      <label><i class="icon wb-paperclip mr-10"></i>Прикрепления | <a href="#">Скачать все</a></label>
      <ul class="list-group attachments-list"></ul>
    </div>
  </section>
  <section class="slidePanel-inner-section">
    <div class="comments">
      <label><i class="icon wb-chat-group mr-10"></i>Комментарии</label>
        ...
        <div class="media-body">
          <div class="comment-body">
            <form class="comment-reply mt-5" method="post" action="#">
              <textarea class="form-control mb-15" placeholder="Введите комментарий" rows="4"></textarea>
              <button class="btn btn-primary" type="button" data-dismiss="modal">Оставить комментарий</button>
            </form>
          </div>
        </div>
      </div>
